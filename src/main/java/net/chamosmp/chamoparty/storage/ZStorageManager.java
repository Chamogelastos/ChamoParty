package net.chamosmp.chamoparty.storage;
...
import net.chamosmp.chamoparty.save.VoteStorage;
import net.chamosmp.chamoparty.storage.storages.JsonStorage;
import net.chamosmp.chamoparty.storage.storages.RedisStorage;
import net.chamosmp.chamoparty.storage.storages.SqlStorage;
